...
# https://www.tutorialspoint.com/longest-palindromic-substring-in-python
...
class longestPalindrome(object):
   def longestPalindrome(self, s):
      # dp is a two dimension array (square with side = s)
      # What's happening at below?
...
ob1 = longestPalindrome()
print(ob1.longestPalindrome("ABBABBCCCCCCDDDCDEEFFFFFEFFFFF"))